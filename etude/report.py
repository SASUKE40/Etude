...
def get_system_info():
    ...
    info['etude_base_dir'] = os.environ.get('ETUDE_BASE_DIR', 'out')
...
def generate_header():
    ...
    header = f"""# etude training report
    ...
    def generate(self):
        ...
        with open(report_file, "w", encoding="utf-8") as out_file:
            ...
            if os.path.exists(header_file):
                ...
                print(f"Warning: {header_file} does not exist. Did you forget to run `etude reset`?")
...
def get_report():
    ...
    from etude.common import get_base_dir, get_dist_info
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Generate or reset etude training reports.")
