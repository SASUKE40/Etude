...
parser = argparse.ArgumentParser(description='Etude Web Server')
...
async def lifespan(app: FastAPI):
    ...
    print("Loading etude models across GPUs...")
...
async def root():
    """Serve the chat UI."""
    ui_html_path = os.path.join("etude", "ui.html")
...
@app.get("/logo.svg")
async def logo():
    """Serve the Etude logo for favicon and header."""
    logo_path = os.path.join("etude", "logo.svg")
...
if __name__ == "__main__":
    import uvicorn
    print(f"Starting Etude Web Server")
