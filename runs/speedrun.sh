...
# Default intermediate artifacts directory is in ~/.cache/etude
export OMP_NUM_THREADS=1
export ETUDE_BASE_DIR="$HOME/.cache/etude"
mkdir -p $ETUDE_BASE_DIR
...
# download 2.3MB of synthetic identity conversations to impart a personality to etude
