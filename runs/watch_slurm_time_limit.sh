...
If sbatch_script is omitted, the script will infer one for known log prefixes:
  ...
  runs/litgpt-sft-<jobid>.log -> runs/litgpt_qwen3_nemotron_instruction_following_sft.slurm
  runs/litgpt-strand-sft-<jobid>.log -> runs/litgpt_qwen3_strandset_rust_sft.slurm
...
normalize_log_prefix() {
    ...
    case "$prefix" in
        d24-h100|d24-h200|d24-rust|d24-sft|litgpt-rust|litgpt-sft|litgpt-strand-sft)
            ;;
        *)
...
infer_sbatch_script() {
    ...
    case "$prefix" in
        ...
        litgpt-sft) echo "runs/litgpt_qwen3_nemotron_instruction_following_sft.slurm" ;;
        litgpt-strand-sft) echo "runs/litgpt_qwen3_strandset_rust_sft.slurm" ;;
        *)
